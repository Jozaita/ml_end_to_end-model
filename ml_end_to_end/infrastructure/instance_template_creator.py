...
class InstanceTemplateCreator:
    ...
    def create_template(self) -> compute_v1.InstanceTemplate:
        ...
        self.logger.info("Instance template created")
    ...
    def _attach_metadata(self) -> None:
        ...
        for metadata_name,metadata_value in self.vm_metadata_config.items():
            self.template.properties.metadata.items.append(compute_v1.Items(key=metadata_name,value=str(metadata_value)))
