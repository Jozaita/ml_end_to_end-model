...
from ml_end_to_end.config_schemas.models.transformation_schemas import CustomHuggingFaceTokenizationTransformationConfig, TransformationConfig
...
class HuggingFaceBackboneConfig(BackBoneConfig):
    _target_: str = "ml_end_to_end.models.backbones.HuggingFaceBackbone"
...
def setup_config():
    ...
    cs.store(name="hugging_face_backbone_schema",group="tasks/lightning_module/model/backbone",node=HuggingFaceBackboneConfig)
    cs.store(name="test_backbone_config",node=BertTinyHuggingFaceBackboneConfig)
