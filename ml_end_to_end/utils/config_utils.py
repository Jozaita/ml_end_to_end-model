...
from ml_end_to_end.utils.io_utils import open_file, write_yaml_file
...
def get_config_and_dict_config(
    config_path: str, config_name: str) -> TaskFunction:
    setup_config()
    setup_logger()
...
def setup_logger() -> None:
    with open("./ml_end_to_end/configs/hydra/job_logging/custom.yaml", "r") as stream:
